...
import com.campingspot.campingspot.BuildConfig;
import java.util.ArrayList;
import java.util.concurrent.Callable;
import java.util.concurrent.ExecutorService;

class FontRequestWorker {
    private static final ExecutorService DEFAULT_EXECUTOR_SERVICE = RequestExecutor.createDefaultExecutor("fonts-androidx", 10, BuildConfig.VERSION_CODE);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x003d, code lost:
        r8 = new androidx.core.provider.FontRequestWorker.C02233();
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:17:0x0046, code lost:
        androidx.core.provider.RequestExecutor.execute(r7, r8, new androidx.core.provider.FontRequestWorker.C02244());
     */
