...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    public void initCartesian(MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f8 = motionPaths3.f18x;
        float f9 = motionPaths3.f19y;
        float f10 = (motionPaths4.f18x + (f4 / 2.0f)) - ((f5 / 2.0f) + f8);
        float f11 = (motionPaths4.f19y + (f6 / 2.0f)) - (f9 + (f7 / 2.0f));
        float f12 = (f4 - f5) * f2;
        float f13 = f12 / 2.0f;
        this.f18x = (float) ((int) ((f8 + (f10 * f)) - f13));
        float f14 = (f6 - f7) * f3;
        float f15 = f14 / 2.0f;
        this.f19y = (float) ((int) ((f9 + (f11 * f)) - f15));
        ...
        this.f18x = (float) ((int) (((motionPaths5.f18x + (f16 * f10)) + (f17 * f11)) - f13));
        this.f19y = (float) ((int) (((motionPaths5.f19y + (f10 * f18)) + (f11 * f)) - f15));
    ...
    public void initPolar(int i, int i2, MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        if (i3 == 1) {
            ...
            float f11 = motionPaths2.f18x;
            float f12 = motionPaths.f18x;
            this.f18x = (f10 * (f11 - f12)) + f12;
            if (!Float.isNaN(motionKeyPosition.mPercentY)) {
                f3 = motionKeyPosition.mPercentY;
            }
            float f13 = motionPaths2.f19y;
            float f14 = motionPaths.f19y;
            this.f19y = (f3 * (f13 - f14)) + f14;
        } else if (i3 != 2) {
            float f15 = Float.isNaN(motionKeyPosition.mPercentX) ? f3 : motionKeyPosition.mPercentX;
            float f16 = motionPaths2.f18x;
            float f17 = motionPaths.f18x;
            this.f18x = (f15 * (f16 - f17)) + f17;
            if (!Float.isNaN(motionKeyPosition.mPercentY)) {
                f3 = motionKeyPosition.mPercentY;
            }
            float f18 = motionPaths2.f19y;
            float f19 = motionPaths.f19y;
            this.f19y = (f3 * (f18 - f19)) + f19;
        } else {
            if (Float.isNaN(motionKeyPosition.mPercentX)) {
                float f20 = motionPaths2.f18x;
                float f21 = motionPaths.f18x;
                f = ((f20 - f21) * f3) + f21;
            } else {
            ...
            this.f18x = f;
            if (Float.isNaN(motionKeyPosition.mPercentY)) {
                float f22 = motionPaths2.f19y;
                float f23 = motionPaths.f19y;
                f2 = (f3 * (f22 - f23)) + f23;
            } else {
    ...
    public void setupRelative(Motion motion, MotionPaths motionPaths) {
        double d = (double) (((this.f18x + (this.width / 2.0f)) - motionPaths.f18x) - (motionPaths.width / 2.0f));
        double d2 = (double) (((this.f19y + (this.height / 2.0f)) - motionPaths.f19y) - (motionPaths.height / 2.0f));
        this.mRelativeToController = motion;
        this.f18x = (float) Math.hypot(d2, d);
        if (Float.isNaN(this.mRelativeAngle)) {
            this.f19y = (float) (Math.atan2(d2, d) + 1.5707963267948966d);
        } else {
            this.f19y = (float) Math.toRadians((double) this.mRelativeAngle);
        }
    }
    ...
    public void initScreen(int i, int i2, MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f8 = motionPaths3.f18x;
        float f9 = motionPaths3.f19y;
        float f10 = motionPaths4.f18x + (f4 / 2.0f);
        float f11 = motionPaths4.f19y + (f6 / 2.0f);
        float f12 = (f4 - f5) * f2;
        this.f18x = (float) ((int) ((f8 + ((f10 - ((f5 / 2.0f) + f8)) * f)) - (f12 / 2.0f)));
        float f13 = (f6 - f7) * f3;
        this.f19y = (float) ((int) ((f9 + ((f11 - (f9 + (f7 / 2.0f))) * f)) - (f13 / 2.0f)));
        this.width = (float) ((int) (f5 + f12));
        this.height = (float) ((int) (f7 + f13));
        this.mMode = 2;
        MotionKeyPosition motionKeyPosition3 = motionKeyPosition;
        if (!Float.isNaN(motionKeyPosition3.mPercentX)) {
            this.f18x = (float) ((int) (motionKeyPosition3.mPercentX * ((float) ((int) (((float) i) - this.width)))));
        }
        if (!Float.isNaN(motionKeyPosition3.mPercentY)) {
            this.f19y = (float) ((int) (motionKeyPosition3.mPercentY * ((float) ((int) (((float) i2) - this.height)))));
        }
    ...
    public void initPath(MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f6 = motionPaths3.f18x;
        float f7 = motionPaths3.width;
        float f8 = motionPaths3.f19y;
        float f9 = motionPaths3.height;
        float f10 = (motionPaths4.f18x + (motionPaths4.width / 2.0f)) - ((f7 / 2.0f) + f6);
        float f11 = (motionPaths4.f19y + (motionPaths4.height / 2.0f)) - ((f9 / 2.0f) + f8);
        float f12 = f10 * f;
        float f13 = f4 * f2;
        float f14 = f13 / 2.0f;
        ...
        this.mMode = 1;
        MotionPaths motionPaths5 = motionPaths;
        float f21 = (float) ((int) ((motionPaths5.f18x + f12) - f14));
        this.f18x = f21;
        float f22 = (float) ((int) ((motionPaths5.f19y + f15) - f17));
        this.f19y = f22;
        this.f18x = f21 + f19;
        this.f19y = f22 + f20;
        this.mAnimateRelativeTo = this.mAnimateRelativeTo;
