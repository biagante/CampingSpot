...
public class ConstraintReference implements Reference {
    ...
    static /* synthetic */ class C01391 {
        ...
        static {
            ...
            L_0x00d8:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.core.state.ConstraintReference.C01391.<clinit>():void");
        }
    }

    public ConstraintReference margin(int i) {
        if (this.mLast != null) {
            switch (C01391.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[this.mLast.ordinal()]) {
                case 1:
                case 2:
                    this.mMarginLeft = i;
                    break;
    ...
    public ConstraintReference bias(float f) {
        ...
        int i = C01391.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[this.mLast.ordinal()];
        if (i != 17) {
            if (i != 18) {
                switch (i) {
                    case 1:
    ...
    private void applyConnection(ConstraintWidget constraintWidget, Object obj, State.Constraint constraint) {
        ...
        if (target != null) {
            int i = C01391.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[constraint.ordinal()];
            switch (C01391.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[constraint.ordinal()]) {
                case 1:
