...
public class BarrierReference extends HelperReference {
    ...
    public void apply() {
        getHelperWidget();
        int i = C01411.$SwitchMap$androidx$constraintlayout$core$state$State$Direction[this.mDirection.ordinal()];
        int i2 = 3;
        if (i == 3 || i == 4) {
            i2 = 1;
        } else if (i == 5) {
    ...
    static /* synthetic */ class C01411 {
        ...
        static {
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.core.state.helpers.BarrierReference.C01411.<clinit>():void");
        }
    }
}
