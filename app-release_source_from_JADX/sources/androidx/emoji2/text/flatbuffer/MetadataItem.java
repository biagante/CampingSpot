...
public final class MetadataItem extends Table {
    ...
    public int mo7572id() {
        ...
        if (__offset != 0) {
            return this.f85bb.getInt(__offset + this.bb_pos);
        }
        return 0;
    }
    ...
    public boolean emojiStyle() {
        ...
        return (__offset == 0 || this.f85bb.get(__offset + this.bb_pos) == 0) ? false : true;
    }

    public short sdkAdded() {
        int __offset = __offset(8);
        if (__offset != 0) {
            return this.f85bb.getShort(__offset + this.bb_pos);
        }
        return 0;
    }
    ...
    public int codepoints(int i) {
        ...
        if (__offset != 0) {
            return this.f85bb.getInt(__vector(__offset) + (i * 4));
        }
        return 0;
    }
    ...
    public IntVector codepointsVector(IntVector intVector) {
        int __offset = __offset(16);
        if (__offset != 0) {
            return intVector.__assign(__vector(__offset), this.f85bb);
        }
        return null;
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public MetadataItem get(MetadataItem metadataItem, int i) {
            return metadataItem.__assign(MetadataItem.__indirect(__element(i), this.f79bb), this.f79bb);
        }
    }
}
