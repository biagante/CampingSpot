...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0020R.styleable.ActionBar);
        this.mBackground = obtainStyledAttributes.getDrawable(C0020R.styleable.ActionBar_background);
        this.mStackedBackground = obtainStyledAttributes.getDrawable(C0020R.styleable.ActionBar_backgroundStacked);
        this.mHeight = obtainStyledAttributes.getDimensionPixelSize(C0020R.styleable.ActionBar_height, -1);
        boolean z = true;
        if (getId() == C0020R.C0022id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = obtainStyledAttributes.getDrawable(C0020R.styleable.ActionBar_backgroundSplit);
        }
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0020R.C0022id.action_bar);
        this.mContextView = findViewById(C0020R.C0022id.action_context_bar);
    }
