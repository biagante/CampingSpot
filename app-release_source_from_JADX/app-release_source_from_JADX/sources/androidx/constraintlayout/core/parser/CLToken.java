    ...
    static /* synthetic */ class C01381 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.core.parser.CLToken.C01381.<clinit>():void");
        }
    }

    public boolean validate(char c, long j) {
        int i = C01381.$SwitchMap$androidx$constraintlayout$core$parser$CLToken$Type[this.type.ordinal()];
        boolean z = false;
        if (i == 1) {
