...
public class CacheDispatcher extends Thread {
    ...
    public void run() {
        if (DEBUG) {
            VolleyLog.m29v("start new dispatcher", new Object[0]);
        }
        ...
        while (true) {
            try {
                ...
                VolleyLog.m27e("Ignoring spurious interrupt of CacheDispatcher thread; use quit() to terminate it", new Object[0]);
            }
        }
    }
