...
public class FlexBuffers {
    ...
    public static class Reference {
        ...
        public int asInt() {
            ...
            int i = this.type;
            if (i == 1) {
                return FlexBuffers.readInt(this.f82bb, this.end, this.parentWidth);
            }
            if (i == 2) {
                access$300 = FlexBuffers.readUInt(this.f82bb, this.end, this.parentWidth);
            } else if (i == 3) {
                return (int) FlexBuffers.readDouble(this.f82bb, this.end, this.parentWidth);
            } else {
                if (i == 5) {
                    return Integer.parseInt(asString());
                }
                if (i == 6) {
                    ReadBuf readBuf = this.f82bb;
                    return FlexBuffers.readInt(readBuf, FlexBuffers.indirect(readBuf, this.end, this.parentWidth), this.byteWidth);
                } else if (i == 7) {
                    ReadBuf readBuf2 = this.f82bb;
                    access$300 = FlexBuffers.readUInt(readBuf2, FlexBuffers.indirect(readBuf2, this.end, this.parentWidth), this.parentWidth);
                } else if (i == 8) {
                    ReadBuf readBuf3 = this.f82bb;
        ...
        public long asUInt() {
            int i = this.type;
            if (i == 2) {
                return FlexBuffers.readUInt(this.f82bb, this.end, this.parentWidth);
            }
            if (i == 1) {
                return FlexBuffers.readLong(this.f82bb, this.end, this.parentWidth);
            }
            if (i == 3) {
                return (long) FlexBuffers.readDouble(this.f82bb, this.end, this.parentWidth);
            }
            if (i == 10) {
                return (long) asVector().size();
            }
            if (i == 26) {
                return (long) FlexBuffers.readInt(this.f82bb, this.end, this.parentWidth);
            }
            if (i == 5) {
        ...
        public double asFloat() {
            int i = this.type;
            if (i == 3) {
                return FlexBuffers.readDouble(this.f82bb, this.end, this.parentWidth);
            }
            if (i == 1) {
                return (double) FlexBuffers.readInt(this.f82bb, this.end, this.parentWidth);
            }
            if (i != 2) {
                if (i == 5) {
            ...
            return (double) FlexBuffers.readUInt(this.f82bb, this.end, this.parentWidth);
        }
        ...
        public String asString() {
            if (isString()) {
                int access$200 = FlexBuffers.indirect(this.f82bb, this.end, this.parentWidth);
                ReadBuf readBuf = this.f82bb;
                int i = this.byteWidth;
                return this.f82bb.getString(access$200, (int) FlexBuffers.readUInt(readBuf, access$200 - i, i));
            } else if (!isKey()) {
                return "";
            } else {
                int access$2002 = FlexBuffers.indirect(this.f82bb, this.end, this.byteWidth);
                int i2 = access$2002;
                while (this.f82bb.get(i2) != 0) {
                    i2++;
                }
                return this.f82bb.getString(access$2002, i2 - access$2002);
            }
        }
    ...
    private static abstract class Sized extends Object {
        ...
        Sized(ReadBuf readBuf, int i, int i2) {
            super(readBuf, i, i2);
            this.size = FlexBuffers.readInt(this.f81bb, i - i2, i2);
        }
    ...
    public static class Blob extends Sized {
        ...
        public ByteBuffer data() {
            ByteBuffer wrap = ByteBuffer.wrap(this.f81bb.data());
        ...
        public byte[] getBytes() {
            ...
            for (int i = 0; i < size; i++) {
                bArr[i] = this.f81bb.get(this.end + i);
            }
            return bArr;
        }

        public byte get(int i) {
            return this.f81bb.get(this.end + i);
        }

        public String toString() {
            return this.f81bb.getString(this.end, size());
        }

        public StringBuilder toString(StringBuilder sb) {
            sb.append('\"');
            sb.append(this.f81bb.getString(this.end, size()));
            sb.append('\"');
            return sb;
        }
    }
    ...
    public static class Key extends Object {
        ...
        public String toString() {
            int i = this.end;
            while (this.f81bb.get(i) != 0) {
                i++;
            }
            return this.f81bb.getString(this.end, i - this.end);
        }
    ...
    public static class Map extends Vector {
        ...
        public KeyVector keys() {
            ...
            return new KeyVector(new TypedVector(this.f81bb, FlexBuffers.indirect(this.f81bb, i, this.byteWidth), FlexBuffers.readInt(this.f81bb, i + this.byteWidth, this.byteWidth), 4));
        }

        public Vector values() {
            return new Vector(this.f81bb, this.end, this.byteWidth);
        }
    ...
    public static class Vector extends Sized {
        ...
        public Reference get(int i) {
            ...
            int byteToUnsignedInt = Unsigned.byteToUnsignedInt(this.f81bb.get((int) (((long) this.end) + (size * ((long) this.byteWidth)) + j)));
            return new Reference(this.f81bb, this.end + (i * this.byteWidth), this.byteWidth, byteToUnsignedInt);
        }
    }
    ...
    public static class TypedVector extends Vector {
        ...
        public Reference get(int i) {
            ...
            return new Reference(this.f81bb, this.end + (i * this.byteWidth), this.byteWidth, 1, this.elemType);
        }
    }
    ...
    public static class KeyVector {
        ...
        public Key get(int i) {
            ...
            return new Key(this.vec.f81bb, FlexBuffers.indirect(this.vec.f81bb, this.vec.end + (i * this.vec.byteWidth), this.vec.byteWidth), 1);
        }
