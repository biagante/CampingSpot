...
class MotionPaths implements Comparable<MotionPaths> {
    ...
    public void initCartesian(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f8 = motionPaths3.f54x;
        float f9 = motionPaths3.f55y;
        float f10 = (motionPaths4.f54x + (f4 / 2.0f)) - ((f5 / 2.0f) + f8);
        float f11 = (motionPaths4.f55y + (f6 / 2.0f)) - (f9 + (f7 / 2.0f));
        float f12 = (f4 - f5) * f2;
        float f13 = f12 / 2.0f;
        this.f54x = (float) ((int) ((f8 + (f10 * f)) - f13));
        float f14 = (f6 - f7) * f3;
        float f15 = f14 / 2.0f;
        this.f55y = (float) ((int) ((f9 + (f11 * f)) - f15));
        ...
        this.f54x = (float) ((int) (((motionPaths5.f54x + (f16 * f10)) + (f17 * f11)) - f13));
        this.f55y = (float) ((int) (((motionPaths5.f55y + (f10 * f18)) + (f11 * f)) - f15));
    ...
    public void initPolar(int i, int i2, KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        if (i3 == 1) {
            ...
            float f11 = motionPaths2.f54x;
            float f12 = motionPaths.f54x;
            this.f54x = (f10 * (f11 - f12)) + f12;
            if (!Float.isNaN(keyPosition.mPercentY)) {
                f3 = keyPosition.mPercentY;
            }
            float f13 = motionPaths2.f55y;
            float f14 = motionPaths.f55y;
            this.f55y = (f3 * (f13 - f14)) + f14;
        } else if (i3 != 2) {
            float f15 = Float.isNaN(keyPosition.mPercentX) ? f3 : keyPosition.mPercentX;
            float f16 = motionPaths2.f54x;
            float f17 = motionPaths.f54x;
            this.f54x = (f15 * (f16 - f17)) + f17;
            if (!Float.isNaN(keyPosition.mPercentY)) {
                f3 = keyPosition.mPercentY;
            }
            float f18 = motionPaths2.f55y;
            float f19 = motionPaths.f55y;
            this.f55y = (f3 * (f18 - f19)) + f19;
        } else {
            if (Float.isNaN(keyPosition.mPercentX)) {
                float f20 = motionPaths2.f54x;
                float f21 = motionPaths.f54x;
                f = ((f20 - f21) * f3) + f21;
            } else {
            ...
            this.f54x = f;
            if (Float.isNaN(keyPosition.mPercentY)) {
                float f22 = motionPaths2.f55y;
                float f23 = motionPaths.f55y;
                f2 = (f3 * (f22 - f23)) + f23;
            } else {
    ...
    public void setupRelative(MotionController motionController, MotionPaths motionPaths) {
        double d = (double) (((this.f54x + (this.width / 2.0f)) - motionPaths.f54x) - (motionPaths.width / 2.0f));
        double d2 = (double) (((this.f55y + (this.height / 2.0f)) - motionPaths.f55y) - (motionPaths.height / 2.0f));
        ...
        if (Float.isNaN(this.mRelativeAngle)) {
            ...
            this.f55y = (float) Math.toRadians((double) this.mRelativeAngle);
        }
    }
    ...
    public void initScreen(int i, int i2, KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f8 = motionPaths3.f54x;
        float f9 = motionPaths3.f55y;
        float f10 = motionPaths4.f54x + (f4 / 2.0f);
        float f11 = motionPaths4.f55y + (f6 / 2.0f);
        float f12 = (f4 - f5) * f2;
        this.f54x = (float) ((int) ((f8 + ((f10 - ((f5 / 2.0f) + f8)) * f)) - (f12 / 2.0f)));
        float f13 = (f6 - f7) * f3;
        this.f55y = (float) ((int) ((f9 + ((f11 - (f9 + (f7 / 2.0f))) * f)) - (f13 / 2.0f)));
        this.width = (float) ((int) (f5 + f12));
        this.height = (float) ((int) (f7 + f13));
        this.mMode = 2;
        KeyPosition keyPosition3 = keyPosition;
        if (!Float.isNaN(keyPosition3.mPercentX)) {
            this.f54x = (float) ((int) (keyPosition3.mPercentX * ((float) ((int) (((float) i) - this.width)))));
        }
        if (!Float.isNaN(keyPosition3.mPercentY)) {
            this.f55y = (float) ((int) (keyPosition3.mPercentY * ((float) ((int) (((float) i2) - this.height)))));
        }
    ...
    public void initPath(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f6 = motionPaths3.f54x;
        float f7 = motionPaths3.width;
        float f8 = motionPaths3.f55y;
        float f9 = motionPaths3.height;
        float f10 = (motionPaths4.f54x + (motionPaths4.width / 2.0f)) - ((f7 / 2.0f) + f6);
        float f11 = (motionPaths4.f55y + (motionPaths4.height / 2.0f)) - ((f9 / 2.0f) + f8);
        float f12 = f10 * f;
        float f13 = f4 * f2;
        float f14 = f13 / 2.0f;
        this.f54x = (float) ((int) ((f6 + f12) - f14));
        float f15 = f * f11;
        float f16 = f5 * f3;
        float f17 = f16 / 2.0f;
        this.f55y = (float) ((int) ((f8 + f15) - f17));
        ...
        this.mMode = 1;
        MotionPaths motionPaths5 = motionPaths;
        float f21 = (float) ((int) ((motionPaths5.f54x + f12) - f14));
        this.f54x = f21;
        float f22 = (float) ((int) ((motionPaths5.f55y + f15) - f17));
        this.f55y = f22;
        this.f54x = f21 + f19;
        this.f55y = f22 + f20;
        this.mAnimateRelativeTo = this.mAnimateRelativeTo;
    ...
    public void different(MotionPaths motionPaths, boolean[] zArr, String[] strArr, boolean z) {
        boolean diff = diff(this.f54x, motionPaths.f54x);
        boolean diff2 = diff(this.f55y, motionPaths.f55y);
