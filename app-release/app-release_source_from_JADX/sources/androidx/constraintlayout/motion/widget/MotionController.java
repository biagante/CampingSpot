...
public class MotionController {
    ...
    public void buildPath(float[] fArr, int i) {
        ...
        while (i3 < i2) {
            ...
            if (easing != null) {
                ...
                float f8 = f6 - f7;
                d = (double) ((((float) easing.get((double) ((f5 - f7) / f8))) * f8) + f7);
            }
            double d2 = d;
            ...
            if (viewOscillator2 != null) {
                fArr[i4] = fArr[i4] + viewOscillator2.get(f9);
            } else if (splineSet != null) {
                fArr[i4] = fArr[i4] + splineSet.get(f9);
            }
            if (viewOscillator3 != null) {
                int i6 = i4 + 1;
                fArr[i6] = fArr[i6] + viewOscillator3.get(f9);
    ...
    public float getKeyFrameParameter(int i, float f, float f2) {
        float f3 = this.mEndMotionPath.f54x - this.mStartMotionPath.f54x;
        float f4 = this.mEndMotionPath.f55y - this.mStartMotionPath.f55y;
        float f5 = this.mStartMotionPath.f54x + (this.mStartMotionPath.width / 2.0f);
        float f6 = this.mStartMotionPath.f55y + (this.mStartMotionPath.height / 2.0f);
    ...
    private float getAdjustedPosition(float f, float[] fArr) {
        ...
        if (fArr != null) {
            ...
            if (f > f4 && ((double) f) < 1.0d) {
                f = Math.min((f - f4) * this.mStaggerScale, 1.0f);
            }
        }
        Easing easing = this.mStartMotionPath.mKeyFrameEasing;
        float f5 = Float.NaN;
    ...
    public void getDpDt(float f, float f2, float f3, float[] fArr) {
        ...
        float f5 = this.mEndMotionPath.f54x - this.mStartMotionPath.f54x;
        float f6 = this.mEndMotionPath.f55y - this.mStartMotionPath.f55y;
    ...
    public void getPostLayoutDvDp(float f, int i, int i2, float f2, float f3, float[] fArr) {
        ...
        if (this.mSpline != null) {
            ...
            float f7 = this.mEndMotionPath.f54x - this.mStartMotionPath.f54x;
            float f8 = this.mEndMotionPath.f55y - this.mStartMotionPath.f55y;
