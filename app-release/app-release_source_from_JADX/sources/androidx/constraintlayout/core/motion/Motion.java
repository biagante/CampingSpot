...
public class Motion implements TypedValues {
    ...
    public void buildPath(float[] fArr, int i) {
        ...
        while (i3 < i2) {
            ...
            if (keyCycleOscillator2 != null) {
                fArr[i4] = fArr[i4] + keyCycleOscillator2.get(f9);
            } else if (splineSet != null) {
                fArr[i4] = fArr[i4] + splineSet.get(f9);
            }
            if (keyCycleOscillator3 != null) {
                int i6 = i4 + 1;
                fArr[i6] = fArr[i6] + keyCycleOscillator3.get(f9);
    ...
    private static DifferentialInterpolator getInterpolator(int i, String str, int i2) {
        ...
        return new DifferentialInterpolator() {
            ...
            public float getVelocity() {
                return (float) interpolator.getDiff((double) this.f15mX);
            }
        };
    }
    ...
    public boolean interpolate(MotionWidget motionWidget, float f, long j, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            float f5 = this.mStartMotionPath.f18x + ((this.mEndMotionPath.f18x - this.mStartMotionPath.f18x) * f4) + 0.5f;
            float f6 = this.mStartMotionPath.f19y + ((this.mEndMotionPath.f19y - this.mStartMotionPath.f19y) * f4) + 0.5f;
    ...
    public void getPostLayoutDvDp(float f, int i, int i2, float f2, float f3, float[] fArr) {
        ...
        if (this.mSpline != null) {
            ...
            float f7 = this.mEndMotionPath.f18x - this.mStartMotionPath.f18x;
            float f8 = this.mEndMotionPath.f19y - this.mStartMotionPath.f19y;
