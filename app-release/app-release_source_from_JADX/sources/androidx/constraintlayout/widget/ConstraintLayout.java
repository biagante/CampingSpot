...
public class ConstraintLayout extends ViewGroup {
        ...
        public final void measure(ConstraintWidget constraintWidget, BasicMeasure.Measure measure) {
            ...
            if (constraintWidget2 != null) {
                if (constraintWidget.getVisibility() == 8 && !constraintWidget.isInPlaceholder()) {
                    ...
                    int i12 = C01731.f58x6d00e4a2[dimensionBehaviour.ordinal()];
                    if (i12 == 1) {
                    ...
                    int i13 = C01731.f58x6d00e4a2[dimensionBehaviour2.ordinal()];
                    if (i13 == 1) {
    ...
    static /* synthetic */ class C01731 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f58x6d00e4a2     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f58x6d00e4a2     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f58x6d00e4a2     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.widget.ConstraintLayout.C01731.<clinit>():void");
        }
    }
    ...
    private void init(AttributeSet attributeSet, int i, int i2) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C0174R.styleable.ConstraintLayout_Layout, i, i2);
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i3 = 0; i3 < indexCount; i3++) {
                int index = obtainStyledAttributes.getIndex(i3);
                if (index == C0174R.styleable.ConstraintLayout_Layout_android_minWidth) {
                    this.mMinWidth = obtainStyledAttributes.getDimensionPixelOffset(index, this.mMinWidth);
                } else if (index == C0174R.styleable.ConstraintLayout_Layout_android_minHeight) {
                    this.mMinHeight = obtainStyledAttributes.getDimensionPixelOffset(index, this.mMinHeight);
                } else if (index == C0174R.styleable.ConstraintLayout_Layout_android_maxWidth) {
                    this.mMaxWidth = obtainStyledAttributes.getDimensionPixelOffset(index, this.mMaxWidth);
                } else if (index == C0174R.styleable.ConstraintLayout_Layout_android_maxHeight) {
                    this.mMaxHeight = obtainStyledAttributes.getDimensionPixelOffset(index, this.mMaxHeight);
                } else if (index == C0174R.styleable.ConstraintLayout_Layout_layout_optimizationLevel) {
                    this.mOptimizationLevel = obtainStyledAttributes.getInt(index, this.mOptimizationLevel);
                } else if (index == C0174R.styleable.ConstraintLayout_Layout_layoutDescription) {
                ...
                } else if (index == C0174R.styleable.ConstraintLayout_Layout_constraintSet) {
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        private static class Table {
            ...
            static {
                ...
                map = sparseIntArray;
                sparseIntArray.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintWidth, 64);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintHeight, 65);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintLeft_toLeftOf, 8);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintLeft_toRightOf, 9);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintRight_toLeftOf, 10);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintRight_toRightOf, 11);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintTop_toTopOf, 12);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintTop_toBottomOf, 13);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintBottom_toTopOf, 14);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintBottom_toBottomOf, 15);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintBaseline_toBaselineOf, 16);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintBaseline_toTopOf, 52);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintBaseline_toBottomOf, 53);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintCircle, 2);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintCircleRadius, 3);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintCircleAngle, 4);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_editor_absoluteX, 49);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_editor_absoluteY, 50);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintGuide_begin, 5);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintGuide_end, 6);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintGuide_percent, 7);
                map.append(C0174R.styleable.ConstraintLayout_Layout_guidelineUseRtl, 67);
                map.append(C0174R.styleable.ConstraintLayout_Layout_android_orientation, 1);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintStart_toEndOf, 17);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintStart_toStartOf, 18);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintEnd_toStartOf, 19);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintEnd_toEndOf, 20);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_goneMarginLeft, 21);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_goneMarginTop, 22);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_goneMarginRight, 23);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_goneMarginBottom, 24);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_goneMarginStart, 25);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_goneMarginEnd, 26);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_goneMarginBaseline, 55);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_marginBaseline, 54);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintHorizontal_bias, 29);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintVertical_bias, 30);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintDimensionRatio, 44);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintHorizontal_weight, 45);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintVertical_weight, 46);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintHorizontal_chainStyle, 47);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintVertical_chainStyle, 48);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constrainedWidth, 27);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constrainedHeight, 28);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintWidth_default, 31);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintHeight_default, 32);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintWidth_min, 33);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintWidth_max, 34);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintWidth_percent, 35);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintHeight_min, 36);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintHeight_max, 37);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintHeight_percent, 38);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintLeft_creator, 39);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintTop_creator, 40);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintRight_creator, 41);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintBottom_creator, 42);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintBaseline_creator, 43);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_constraintTag, 51);
                map.append(C0174R.styleable.ConstraintLayout_Layout_layout_wrapBehaviorInParent, 66);
            }
        }

        public LayoutParams(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0174R.styleable.ConstraintLayout_Layout);
            int indexCount = obtainStyledAttributes.getIndexCount();
