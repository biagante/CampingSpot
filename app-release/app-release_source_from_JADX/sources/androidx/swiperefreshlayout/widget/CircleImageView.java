...
import androidx.swiperefreshlayout.C0406R;
...
class CircleImageView extends ImageView {
    ...
    CircleImageView(Context context) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(C0406R.styleable.SwipeRefreshLayout);
        this.mBackgroundColor = obtainStyledAttributes.getColor(C0406R.styleable.f89xaa980688, DEFAULT_BACKGROUND_COLOR);
