...
public class MotionScene {
    ...
    public static class Transition {
        ...
        public static class TransitionOnClick implements View.OnClickListener {
            ...
            public TransitionOnClick(Context context, Transition transition, XmlPullParser xmlPullParser) {
                ...
                TypedArray obtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(xmlPullParser), C0174R.styleable.OnClick);
                int indexCount = obtainStyledAttributes.getIndexCount();
                for (int i = 0; i < indexCount; i++) {
                    int index = obtainStyledAttributes.getIndex(i);
                    if (index == C0174R.styleable.OnClick_targetId) {
                        this.mTargetId = obtainStyledAttributes.getResourceId(index, this.mTargetId);
                    } else if (index == C0174R.styleable.OnClick_clickAction) {
        ...
        private void fillFromAttributeList(MotionScene motionScene, Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0174R.styleable.Transition);
        ...
        private void fill(MotionScene motionScene, Context context, TypedArray typedArray) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == C0174R.styleable.Transition_constraintSetEnd) {
                ...
                } else if (index == C0174R.styleable.Transition_constraintSetStart) {
                ...
                } else if (index == C0174R.styleable.Transition_motionInterpolator) {
                ...
                } else if (index == C0174R.styleable.Transition_duration) {
                    int i2 = typedArray.getInt(index, this.mDuration);
                    this.mDuration = i2;
                    if (i2 < 8) {
                        this.mDuration = 8;
                    }
                } else if (index == C0174R.styleable.Transition_staggered) {
                    this.mStagger = typedArray.getFloat(index, this.mStagger);
                } else if (index == C0174R.styleable.Transition_autoTransition) {
                    this.mAutoTransition = typedArray.getInteger(index, this.mAutoTransition);
                } else if (index == C0174R.styleable.Transition_android_id) {
                    this.mId = typedArray.getResourceId(index, this.mId);
                } else if (index == C0174R.styleable.Transition_transitionDisable) {
                    this.mDisable = typedArray.getBoolean(index, this.mDisable);
                } else if (index == C0174R.styleable.Transition_pathMotionArc) {
                    this.mPathMotionArc = typedArray.getInteger(index, -1);
                } else if (index == C0174R.styleable.Transition_layoutDuringTransition) {
                    this.mLayoutDuringTransition = typedArray.getInteger(index, 0);
                } else if (index == C0174R.styleable.Transition_transitionFlags) {
    ...
    MotionScene(Context context, MotionLayout motionLayout, int i) {
        ...
        this.mViewTransitionController = new ViewTransitionController(motionLayout);
        load(context, i);
        this.mConstraintSetMap.put(C0174R.C0176id.motion_base, new ConstraintSet());
        this.mConstraintSetIdMap.put("motion_base", Integer.valueOf(C0174R.C0176id.motion_base));
    }
    ...
    private void load(android.content.Context r9, int r10) {
        /*
            ...
            r1 = 0
            int r2 = r0.getEventType()     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
        L_0x000d:
            r3 = 1
            ...
            goto L_0x0167
        L_0x0017:
            java.lang.String r2 = r0.getName()     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            boolean r5 = r8.DEBUG_DESKTOP     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            if (r5 == 0) goto L_0x0035
            java.io.PrintStream r5 = java.lang.System.out     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            java.lang.StringBuilder r6 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            r6.<init>()     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            java.lang.String r7 = "parsing = "
            r6.append(r7)     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            r6.append(r2)     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            java.lang.String r6 = r6.toString()     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            r5.println(r6)     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
        L_0x0035:
            int r5 = r2.hashCode()     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
        ...
        L_0x0041:
            ...
            boolean r2 = r2.equals(r3)     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
        ...
        L_0x004b:
            ...
            goto L_0x00a5
        L_0x0055:
            boolean r2 = r2.equals(r6)     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            if (r2 == 0) goto L_0x00a4
            r3 = 0
            goto L_0x00a5
        L_0x005d:
        ...
        L_0x0071:
            ...
            boolean r2 = r2.equals(r4)     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            if (r2 == 0) goto L_0x00a4
            goto L_0x00a5
        L_0x007a:
        ...
        L_0x00a5:
            ...
            }     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
        L_0x00a8:
            goto L_0x0167
        L_0x00aa:
            androidx.constraintlayout.motion.widget.ViewTransition r2 = new androidx.constraintlayout.motion.widget.ViewTransition     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            r2.<init>(r9, r0)     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            androidx.constraintlayout.motion.widget.ViewTransitionController r3 = r8.mViewTransitionController     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            r3.add(r2)     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            goto L_0x0167
        L_0x00b6:
            androidx.constraintlayout.motion.widget.KeyFrames r2 = new androidx.constraintlayout.motion.widget.KeyFrames     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            r2.<init>(r9, r0)     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            if (r1 == 0) goto L_0x0167
            java.util.ArrayList r3 = r1.mKeyFramesList     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            r3.add(r2)     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            goto L_0x0167
        L_0x00c6:
            r8.parseInclude((android.content.Context) r9, (org.xmlpull.v1.XmlPullParser) r0)     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            goto L_0x0167
        L_0x00cb:
            r8.parseConstraintSet(r9, r0)     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            goto L_0x0167
        L_0x00d0:
            androidx.constraintlayout.widget.StateSet r2 = new androidx.constraintlayout.widget.StateSet     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            r2.<init>(r9, r0)     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            r8.mStateSet = r2     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            goto L_0x0167
        L_0x00d9:
            if (r1 == 0) goto L_0x0167
            r1.addOnClick((android.content.Context) r9, (org.xmlpull.v1.XmlPullParser) r0)     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            goto L_0x0167
        L_0x00e0:
            if (r1 != 0) goto L_0x010f
            android.content.res.Resources r2 = r9.getResources()     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            java.lang.String r2 = r2.getResourceEntryName(r10)     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            int r3 = r0.getLineNumber()     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            r4.<init>()     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            java.lang.String r5 = " OnSwipe ("
            r4.append(r5)     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            r4.append(r2)     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            java.lang.String r2 = ".xml:"
            r4.append(r2)     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            r4.append(r3)     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            java.lang.String r2 = ")"
            r4.append(r2)     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            java.lang.String r2 = r4.toString()     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            android.util.Log.v(r6, r2)     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
        L_0x010f:
            if (r1 == 0) goto L_0x0167
            androidx.constraintlayout.motion.widget.TouchResponse r2 = new androidx.constraintlayout.motion.widget.TouchResponse     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            androidx.constraintlayout.motion.widget.MotionLayout r3 = r8.mMotionLayout     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            r2.<init>(r9, r3, r0)     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            androidx.constraintlayout.motion.widget.TouchResponse unused = r1.mTouchResponse = r2     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            goto L_0x0167
        L_0x011c:
            java.util.ArrayList<androidx.constraintlayout.motion.widget.MotionScene$Transition> r1 = r8.mTransitionList     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            androidx.constraintlayout.motion.widget.MotionScene$Transition r2 = new androidx.constraintlayout.motion.widget.MotionScene$Transition     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            r2.<init>(r8, r9, r0)     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            r1.add(r2)     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            androidx.constraintlayout.motion.widget.MotionScene$Transition r1 = r8.mCurrentTransition     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            if (r1 != 0) goto L_0x0145
            boolean r1 = r2.mIsAbstract     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            if (r1 != 0) goto L_0x0145
            r8.mCurrentTransition = r2     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            if (r2 == 0) goto L_0x0145
            androidx.constraintlayout.motion.widget.TouchResponse r1 = r2.mTouchResponse     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            if (r1 == 0) goto L_0x0145
            androidx.constraintlayout.motion.widget.MotionScene$Transition r1 = r8.mCurrentTransition     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            androidx.constraintlayout.motion.widget.TouchResponse r1 = r1.mTouchResponse     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            boolean r3 = r8.mRtl     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            r1.setRTL(r3)     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
        L_0x0145:
            boolean r1 = r2.mIsAbstract     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            if (r1 == 0) goto L_0x015e
            int r1 = r2.mConstraintSetEnd     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            if (r1 != r7) goto L_0x0154
            r8.mDefaultTransition = r2     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            goto L_0x0159
        L_0x0154:
            java.util.ArrayList<androidx.constraintlayout.motion.widget.MotionScene$Transition> r1 = r8.mAbstractTransitionList     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            r1.add(r2)     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
        L_0x0159:
            java.util.ArrayList<androidx.constraintlayout.motion.widget.MotionScene$Transition> r1 = r8.mTransitionList     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            r1.remove(r2)     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
        L_0x015e:
            r1 = r2
            goto L_0x0167
        L_0x0160:
            r8.parseMotionSceneTags(r9, r0)     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            goto L_0x0167
        L_0x0164:
            r0.getName()     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
        L_0x0167:
            int r2 = r0.next()     // Catch:{ XmlPullParserException -> 0x0172, IOException -> 0x016d }
            goto L_0x000d
        L_0x016d:
            r9 = move-exception
            r9.printStackTrace()
    ...
    private void parseMotionSceneTags(Context context, XmlPullParser xmlPullParser) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(xmlPullParser), C0174R.styleable.MotionScene);
        int indexCount = obtainStyledAttributes.getIndexCount();
        for (int i = 0; i < indexCount; i++) {
            int index = obtainStyledAttributes.getIndex(i);
            if (index == C0174R.styleable.MotionScene_defaultDuration) {
                int i2 = obtainStyledAttributes.getInt(index, this.mDefaultDuration);
                this.mDefaultDuration = i2;
                if (i2 < 8) {
                    this.mDefaultDuration = 8;
                }
            } else if (index == C0174R.styleable.MotionScene_layoutDuringTransition) {
    ...
    private void parseInclude(Context context, XmlPullParser xmlPullParser) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(xmlPullParser), C0174R.styleable.include);
        int indexCount = obtainStyledAttributes.getIndexCount();
        for (int i = 0; i < indexCount; i++) {
            int index = obtainStyledAttributes.getIndex(i);
            if (index == C0174R.styleable.include_constraintSet) {
    ...
    private int parseConstraintSet(android.content.Context r14, org.xmlpull.v1.XmlPullParser r15) {
        ...
        L_0x0036:
            ...
            r11 = -1153153640(0xffffffffbb444598, float:-0.0029948708)
        ...
        L_0x0069:
            ...
            if (r8 == r12) goto L_0x0071
            goto L_0x00ed
        L_0x0071:
            int r8 = java.lang.Integer.parseInt(r9)     // Catch:{ NumberFormatException -> 0x0079 }
            r0.mRotate = r8     // Catch:{ NumberFormatException -> 0x0079 }
            goto L_0x00ed
        L_0x0079:
            int r8 = r9.hashCode()
            r10 = 4
            r11 = 3
            switch(r8) {
                case -768416914: goto L_0x00ac;
                case 3317767: goto L_0x00a2;
                case 3387192: goto L_0x0098;
                case 108511772: goto L_0x008e;
                case 1954540437: goto L_0x0084;
