...
public class State {
    ...
    public HelperReference helper(Object obj, Helper helper) {
        ...
        if (helperReference2 == null) {
            int i = C01401.$SwitchMap$androidx$constraintlayout$core$state$State$Helper[helper.ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C01401 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.core.state.State.C01401.<clinit>():void");
        }
    }
