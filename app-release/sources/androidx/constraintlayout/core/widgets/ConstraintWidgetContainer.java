...
public class ConstraintWidgetContainer extends WidgetContainer {
    ...
    public void layout() {
        ...
        L_0x0146:
            ...
            int r15 = r0 + 1
            androidx.constraintlayout.core.LinearSystem r0 = r1.mSystem     // Catch:{ Exception -> 0x01ff }
            r0.reset()     // Catch:{ Exception -> 0x01ff }
            r18.resetChains()     // Catch:{ Exception -> 0x01ff }
            androidx.constraintlayout.core.LinearSystem r0 = r1.mSystem     // Catch:{ Exception -> 0x01ff }
            r1.createObjectVariables(r0)     // Catch:{ Exception -> 0x01ff }
            r0 = 0
        L_0x0158:
            if (r0 >= r3) goto L_0x016c
            java.util.ArrayList r6 = r1.mChildren     // Catch:{ Exception -> 0x01ff }
            java.lang.Object r6 = r6.get(r0)     // Catch:{ Exception -> 0x01ff }
            androidx.constraintlayout.core.widgets.ConstraintWidget r6 = (androidx.constraintlayout.core.widgets.ConstraintWidget) r6     // Catch:{ Exception -> 0x01ff }
            androidx.constraintlayout.core.LinearSystem r2 = r1.mSystem     // Catch:{ Exception -> 0x01ff }
            r6.createObjectVariables(r2)     // Catch:{ Exception -> 0x01ff }
            int r0 = r0 + 1
            r2 = 0
            r6 = 1
            goto L_0x0158
        L_0x016c:
            androidx.constraintlayout.core.LinearSystem r0 = r1.mSystem     // Catch:{ Exception -> 0x01ff }
            boolean r14 = r1.addChildrenToSolver(r0)     // Catch:{ Exception -> 0x01ff }
            java.lang.ref.WeakReference<androidx.constraintlayout.core.widgets.ConstraintAnchor> r0 = r1.verticalWrapMin     // Catch:{ Exception -> 0x01ff }
            r2 = 0
            if (r0 == 0) goto L_0x0194
            java.lang.ref.WeakReference<androidx.constraintlayout.core.widgets.ConstraintAnchor> r0 = r1.verticalWrapMin     // Catch:{ Exception -> 0x01ff }
            java.lang.Object r0 = r0.get()     // Catch:{ Exception -> 0x01ff }
            if (r0 == 0) goto L_0x0194
            java.lang.ref.WeakReference<androidx.constraintlayout.core.widgets.ConstraintAnchor> r0 = r1.verticalWrapMin     // Catch:{ Exception -> 0x01ff }
            java.lang.Object r0 = r0.get()     // Catch:{ Exception -> 0x01ff }
            androidx.constraintlayout.core.widgets.ConstraintAnchor r0 = (androidx.constraintlayout.core.widgets.ConstraintAnchor) r0     // Catch:{ Exception -> 0x01ff }
            androidx.constraintlayout.core.LinearSystem r6 = r1.mSystem     // Catch:{ Exception -> 0x01ff }
            androidx.constraintlayout.core.widgets.ConstraintAnchor r8 = r1.mTop     // Catch:{ Exception -> 0x01ff }
            androidx.constraintlayout.core.SolverVariable r6 = r6.createObjectVariable(r8)     // Catch:{ Exception -> 0x01ff }
            r1.addMinWrap(r0, r6)     // Catch:{ Exception -> 0x01ff }
            r1.verticalWrapMin = r2     // Catch:{ Exception -> 0x01ff }
        L_0x0194:
            java.lang.ref.WeakReference<androidx.constraintlayout.core.widgets.ConstraintAnchor> r0 = r1.verticalWrapMax     // Catch:{ Exception -> 0x01ff }
            ...
            androidx.constraintlayout.core.widgets.ConstraintAnchor r0 = (androidx.constraintlayout.core.widgets.ConstraintAnchor) r0     // Catch:{ Exception -> 0x01ff }
            androidx.constraintlayout.core.LinearSystem r6 = r1.mSystem     // Catch:{ Exception -> 0x01ff }
            androidx.constraintlayout.core.widgets.ConstraintAnchor r8 = r1.mBottom     // Catch:{ Exception -> 0x01ff }
            androidx.constraintlayout.core.SolverVariable r6 = r6.createObjectVariable(r8)     // Catch:{ Exception -> 0x01ff }
            r1.addMaxWrap(r0, r6)     // Catch:{ Exception -> 0x01ff }
            r1.verticalWrapMax = r2     // Catch:{ Exception -> 0x01ff }
        L_0x01b5:
            java.lang.ref.WeakReference<androidx.constraintlayout.core.widgets.ConstraintAnchor> r0 = r1.horizontalWrapMin     // Catch:{ Exception -> 0x01ff }
            ...
            androidx.constraintlayout.core.widgets.ConstraintAnchor r0 = (androidx.constraintlayout.core.widgets.ConstraintAnchor) r0     // Catch:{ Exception -> 0x01ff }
            androidx.constraintlayout.core.LinearSystem r6 = r1.mSystem     // Catch:{ Exception -> 0x01ff }
            androidx.constraintlayout.core.widgets.ConstraintAnchor r8 = r1.mLeft     // Catch:{ Exception -> 0x01ff }
            androidx.constraintlayout.core.SolverVariable r6 = r6.createObjectVariable(r8)     // Catch:{ Exception -> 0x01ff }
            r1.addMinWrap(r0, r6)     // Catch:{ Exception -> 0x01ff }
            r1.horizontalWrapMin = r2     // Catch:{ Exception -> 0x01ff }
        L_0x01d6:
            java.lang.ref.WeakReference<androidx.constraintlayout.core.widgets.ConstraintAnchor> r0 = r1.horizontalWrapMax     // Catch:{ Exception -> 0x01ff }
            ...
            androidx.constraintlayout.core.widgets.ConstraintAnchor r0 = (androidx.constraintlayout.core.widgets.ConstraintAnchor) r0     // Catch:{ Exception -> 0x01ff }
            androidx.constraintlayout.core.LinearSystem r6 = r1.mSystem     // Catch:{ Exception -> 0x01ff }
            androidx.constraintlayout.core.widgets.ConstraintAnchor r8 = r1.mRight     // Catch:{ Exception -> 0x01ff }
            androidx.constraintlayout.core.SolverVariable r6 = r6.createObjectVariable(r8)     // Catch:{ Exception -> 0x01ff }
            r1.addMaxWrap(r0, r6)     // Catch:{ Exception -> 0x01ff }
            r1.horizontalWrapMax = r2     // Catch:{ Exception -> 0x01ff }
        L_0x01f7:
            if (r14 == 0) goto L_0x0219
            androidx.constraintlayout.core.LinearSystem r0 = r1.mSystem     // Catch:{ Exception -> 0x01ff }
            r0.minimize()     // Catch:{ Exception -> 0x01ff }
            goto L_0x0219
        L_0x01ff:
            r0 = move-exception
            r0.printStackTrace()
