...
class DefaultSpecialEffectsController extends SpecialEffectsController {
    ...
    public void executeOperations(List<SpecialEffectsController.Operation> list, boolean z) {
        ...
        for (SpecialEffectsController.Operation next : list) {
            ...
            int i = C028210.f86xe493b431[next.getFinalState().ordinal()];
            if (i == 1 || i == 2 || i == 3) {
    ...
    static /* synthetic */ class C028210 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f86xe493b431     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f86xe493b431     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f86xe493b431     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.fragment.app.DefaultSpecialEffectsController.C028210.<clinit>():void");
        }
    }
                ...
                if (animation == null) {
                    ...
                    if (animator == null) {
                        ...
                        if (Boolean.TRUE.equals(map.get(operation))) {
                            ...
                            C02832 r0 = new AnimatorListenerAdapter() {
