...
public class FlatBufferBuilder {
    ...
    public FlatBufferBuilder(int i, ByteBufferFactory byteBufferFactory, ByteBuffer byteBuffer, Utf8 utf82) {
        ...
        if (byteBuffer != null) {
            this.f80bb = byteBuffer;
            byteBuffer.clear();
            this.f80bb.order(ByteOrder.LITTLE_ENDIAN);
        } else {
            this.f80bb = byteBufferFactory.newByteBuffer(i);
        }
        this.utf8 = utf82;
        this.space = this.f80bb.capacity();
    }
    ...
    public int offset() {
        return this.f80bb.capacity() - this.space;
    }

    public void pad(int i) {
        for (int i2 = 0; i2 < i; i2++) {
            ByteBuffer byteBuffer = this.f80bb;
            int i3 = this.space - 1;
            this.space = i3;
    ...
    public ByteBuffer createUnintializedVector(int i, int i2, int i3) {
        ...
        ByteBuffer order = this.f80bb.slice().order(ByteOrder.LITTLE_ENDIAN);
        order.limit(i4);
        return order;
    }
    ...
    public int createString(CharSequence charSequence) {
        ...
        this.utf8.encodeUtf8(charSequence, this.f80bb);
        return endVector();
    }
    ...
    public int createString(ByteBuffer byteBuffer) {
        ...
        ByteBuffer byteBuffer2 = this.f80bb;
        int i = this.space - remaining;
        this.space = i;
        byteBuffer2.position(i);
        this.f80bb.put(byteBuffer);
        return endVector();
    }
    ...
    public int endTable() {
        ...
        while (true) {
            ...
            int capacity = this.f80bb.capacity() - this.vtables[i4];
            int i5 = this.space;
            short s = this.f80bb.getShort(capacity);
            if (s == this.f80bb.getShort(i5)) {
                int i6 = 2;
                while (i6 < s) {
                    if (this.f80bb.getShort(capacity + i6) == this.f80bb.getShort(i5 + i6)) {
                        i6 += 2;
                    }
                }
                i = this.vtables[i4];
        ...
        if (i != 0) {
            int capacity2 = this.f80bb.capacity() - offset;
            this.space = capacity2;
            this.f80bb.putInt(capacity2, i - offset);
        } else {
    ...
    public void required(int i, int i2) {
        int capacity = this.f80bb.capacity() - i;
        if (!(this.f80bb.getShort((capacity - this.f80bb.getInt(capacity)) + i2) != 0)) {
    ...
    public void finish(int i, boolean z) {
        ...
        addOffset(i);
        if (z) {
            addInt(this.f80bb.capacity() - this.space);
        }
        this.f80bb.position(this.space);
        this.finished = true;
    }
    ...
    public byte[] sizedByteArray(int i, int i2) {
        ...
        this.f80bb.position(i);
        this.f80bb.get(bArr);
        return bArr;
    }

    public byte[] sizedByteArray() {
        return sizedByteArray(this.space, this.f80bb.capacity() - this.space);
    }

    public InputStream sizedInputStream() {
        finished();
        ByteBuffer duplicate = this.f80bb.duplicate();
        duplicate.position(this.space);
        duplicate.limit(this.f80bb.capacity());
